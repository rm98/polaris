// This script generates the Kubernetes CRDs for the @rm98/polaris-common-mappings library.
...
} from '@rm98/polaris-common-mappings';
import { PolarisConstructor } from '@rm98/polaris-core';
import { initPolarisKubernetes } from '@rm98/polaris-kubernetes';
import { CustomResourceDefinitionWriter } from '@rm98/polaris-schema-gen';
